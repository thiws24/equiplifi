...
const mockData = [{id: 1, name: "Magischer Schlüssel", icon: "🗝️", photoUrl: "", urn: "QR-Code 001"}, {
    id: 2,
    name: "Heiltrank",
    icon: "🧪",
    photoUrl: "",
    urn: "QR-Code 002"
}, {id: 3, name: "Drachenfeuer", icon: "🔥", photoUrl: "", urn: "QR-Code 003"},]

function mockFetch() {
    return jest.fn().mockImplementation(() => Promise.resolve({ok: true, json: () => mockData,}),);
}
