...
function Home() {
    ...
    const colDefs: ColDef<InventoryItemProps, any>[] = [{
        ...
        flex: 1,
        minWidth: 150,
        cellRenderer: (params: any) => <img style={{height: 40}} src={params.data.photoUrl}
    ...
    return (<div className="m-10">
        <main className="main">
            <div
                className='font-semibold text-3xl text-customBlue flex justify-center w-full text-center'>Inventarverwaltung
            </div>
            <TableGalleryView data={inventoryItems} colDefs={colDefs} loading={loading}/></main>
    </div>);
}
